...
# sed -i "s|alpine-minirootfs-[0-9.]*-x86_64.tar.gz|alpine-minirootfs-${penultimate_version}-x86_64.tar.gz|" /home/vboxuser/inception/srcs/containers/nginx/Dockerfile
# sed -i "s|alpine-minirootfs-[0-9.]*-x86_64.tar.gz|alpine-minirootfs-${penultimate_version}-x86_64.tar.gz|" /home/vboxuser/inception/srcs/containers/mariadb/Dockerfile
